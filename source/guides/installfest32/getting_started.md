---
github_url: https://github.com/reinteractive-open/installfest_guides/tree/master/source/guides/installfest32/getting_started.md
---
...
1. A working version of Rails 3.2 which you can install using [Rails Installer](http://railsinstaller.org/) for Windows or Mac. Note: For Mac users with newer versions of OS X, please use [this alternative guide on getting started](/guides/installfest/rails_on_mavericks).
...
![Rails default homepage](/images/guides/rails_default_home.png)
...
Welcome to Ruby on Rails. If you're this far along you should definitely [head on over to Part 2](/guides/installfest32/finishing_a_basic_blog) which goes more in depth with Rails and begins to add more features to the blogging engine.
