---
github_url: https://github.com/reinteractive-open/installfest_guides/tree/master/source/guides/installfest50/understanding_migrations.md
---

# Understanding Migrations
Welcome back to reinteractive's Ruby on Rails 15 minute blog tutorial series.
If you haven't started following through the series and you're new to Rails then you might want to begin with [Getting Started](/guides/installfest50/getting_started). Today we'll be following directly on from [Part 4](/guides/installfest50/admin_and_markdown). If you feel confident with Rails and want to learn more about building a feature that requires migrations then instructions for doing so are provided below.
...
You'll need to have been following our InstallFest blog posts beginning with [Getting Started](/guides/installfest50/getting_started), and have completed [Admin and Markdown](/guides/installfest50/admin_and_markdown).
...
The next post in the series is available [here](/guides/installfest50/assets_and_errors). You'll be learning about the Asset Pipeline, Static pages and Custom error pages. If you want to learn more about reinteractive's training services you can:
