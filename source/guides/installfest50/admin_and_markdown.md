---
github_url: https://github.com/reinteractive-open/installfest_guides/tree/master/source/guides/installfest50/admin_and_markdown.md
---
...
If you haven't started following through the series and you're new to Rails then you might want to begin with [Getting Started](/guides/installfest50/getting_started). Today we'll be following directly on from [Part 3](/guides/installfest50/testing_the_blog). If you feel confident with Rails but want to learn more about ActiveAdmin and/or Markdown you can find some instructions on getting the code set up properly below.
...
You'll need to have been following our InstallFest blog posts starting with [Getting Started](/guides/installfest50/getting_started) and have completed [Testing the Blog](/guides/installfest50/testing_the_blog).
...
Download: [https://raw.github.com/richleland/pygments-css/master/github.css](https://raw.github.com/richleland/pygments-css/master/github.css) into `vendor/assets/stylesheets`, then open `app/assets/stylesheets/foundation_and_overrides.scss` and add the following line to the bottom:
...
Up next we'll add features to your blog and learn more about Rails migrations. Click [here](/guides/installfest50/understanding_migrations) to check it out and continue your Rails adventure.
